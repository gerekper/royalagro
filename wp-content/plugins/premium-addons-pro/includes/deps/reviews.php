...
define( 'PREMIUM_FB_REV_AVATAR', PREMIUM_PRO_ADDONS_URL . 'assets/frontend/images/person-image.jpg' );
				...
				?>
					<div class="premium-fb-rev-review-wrap">
							<div class="premium-fb-rev-review">
								...
								<?php if ( 'default' === $skin_type && 'yes' === $settings['show_image'] ) { ?>
									<div class="premium-fb-rev-content-left">
										<img class="premium-fb-rev-img" src="<?php echo esc_url( $image_link ); ?>" alt="<?php echo esc_attr( $review->reviewer->name ); ?>" onerror=" if( this.src!='<?php echo esc_url( PREMIUM_FB_REV_AVATAR ); ?>' ) this.src='<?php echo esc_url( PREMIUM_FB_REV_AVATAR ); ?>';">
									</div>
								<?php } ?>
								<div class="premium-fb-rev-content-right">
									...
									<?php endif; ?>
									<?php if ( 'card' === $skin_type && 'yes' === $settings['show_image'] ) { ?>
										<div class="premium-fb-rev-content-left">
											<img class="premium-fb-rev-img" src="<?php echo esc_url( $image_link ); ?>" alt="<?php echo esc_attr( $review->reviewer->name ); ?>" onerror=" if( this.src!='<?php echo esc_url( PREMIUM_FB_REV_AVATAR ); ?>' ) this.src='<?php echo esc_url( PREMIUM_FB_REV_AVATAR ); ?>';">
										</div>
									<?php } ?>
			...
			if ( $min_filter <= $review->rating && $review->rating <= $max_filter ) {
				...
				<div class="premium-fb-rev-review-wrap">
					<div class="premium-fb-rev-review">
						...
						<?php if ( 'default' === $skin_type && 'yes' === $settings['show_image'] ) { ?>
							<div class="premium-fb-rev-content-left">
								<img class="premium-fb-rev-img" src="<?php echo esc_url( $author_photo ); ?>" alt="<?php echo esc_attr( $review->author_name ); ?>" onerror="if( this.src!='<?php echo esc_url( PREMIUM_FB_REV_AVATAR ); ?>' ) this.src='<?php echo esc_url( PREMIUM_FB_REV_AVATAR ); ?>';">
							</div>
						<?php } ?>
						<div class="premium-fb-rev-content-right">
							<div class="premium-fb-rev-reviewer-wrapper">
			...
			if ( $min_filter <= $review->rating && $review->rating <= $max_filter ) {
				...
				<div class="premium-fb-rev-review-wrap">
					<div class="premium-fb-rev-review">
						...
						<?php if ( 'default' === $skin_type && 'yes' === $settings['show_image'] ) { ?>
							<div class="premium-fb-rev-content-left">
								<img class="premium-fb-rev-img" src="<?php echo esc_url( $author_photo ); ?>" alt="<?php echo esc_attr( $review->name ); ?>" onerror="if( this.src!='<?php echo esc_url( PREMIUM_FB_REV_AVATAR ); ?>' ) this.src='<?php echo esc_url( PREMIUM_FB_REV_AVATAR ); ?>';">
							</div>
						<?php } ?>
							<div class="premium-fb-rev-content-right">
								<div class="premium-fb-rev-reviewer-wrapper">
						...
						?>
							...
							if ( isset( $review->text ) && $rev_text ) :
								?>
									...
									<?php if ( 'card' === $skin_type && 'yes' === $settings['show_image'] ) { ?>
										<div class="premium-fb-rev-content-left">
											<img class="premium-fb-rev-img" src="<?php echo esc_url( $author_photo ); ?>" alt="<?php echo esc_attr( $review->name ); ?>" onerror="if( this.src!='<?php echo esc_attr( PREMIUM_FB_REV_AVATAR ); ?>' ) this.src='<?php echo esc_attr( PREMIUM_FB_REV_AVATAR ); ?>';">
										</div>
									<?php } ?>
							</div>
						</div>
